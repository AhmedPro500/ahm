...
            })
        r.catch(() => {
            return puz.night.send(`:negative_squared_cross_mark: لقد انتهى الوقت ولم يقم أحد بالأجابة بشكل صحيح
            `)
        })
       
        r.then((collected)=> {
...
       
        var x3 = Math.floor(Math.random()*x.length)
        fkk.night.send(`اول شخص يفكك :  __**${x[x3]}**__
        
...
 
 
client.login('NTUxNDAzNzg5NDI1MzExODAy.D1weUQ.5ncKO6F0NFwyGSjg_XxvArD_2_0');
RAW Paste Data